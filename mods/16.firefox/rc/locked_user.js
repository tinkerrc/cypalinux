...
lockPref("browser.newtabpage.activity-stream.feeds.snippets", false); // [DEFAULT: false]
...
lockPref("browser.newtabpage.activity-stream.showSponsoredTopSites", false); // [FF83+]
...
lockPref("browser.urlbar.suggest.quicksuggest", false);
...
lockPref("security.password_lifetime", 5); // [DEFAULT: 30]
...
lockPref("network.http.windows-sso.enabled", false); // [DEFAULT: false]
...
lockPref("browser.sessionstore.interval", 30000); // [DEFAULT: 15000]
...
lockPref("privacy.clearOnShutdown.cache", true);     // [DEFAULT: true]
lockPref("privacy.clearOnShutdown.downloads", true); // [DEFAULT: true]
lockPref("privacy.clearOnShutdown.formdata", true);  // [DEFAULT: true]
lockPref("privacy.clearOnShutdown.history", true);   // [DEFAULT: true]
lockPref("privacy.clearOnShutdown.sessions", true);  // [DEFAULT: true]
...
lockPref("privacy.cpd.cache", true);    // [DEFAULT: true]
lockPref("privacy.cpd.formdata", true); // [DEFAULT: true]
lockPref("privacy.cpd.history", true);  // [DEFAULT: true]
lockPref("privacy.cpd.sessions", true); // [DEFAULT: true]
...
***/
lockPref("_user.js.parrot", "5000 syntax error: the parrot's taken 'is last bow");
...
***/
lockPref("_user.js.parrot", "5500 syntax error: this is an ex-parrot!");
...
lockPref("_user.js.parrot", "6000 syntax error: the parrot's 'istory!");
...
lockPref("_user.js.parrot", "7000 syntax error: the parrot's pushing up daisies!");
/* 7001: disable APIs
...
***/
lockPref("_user.js.parrot", "8000 syntax error: the parrot's crossed the Jordan");
/* 8001: disable APIs ***/
...
***/
lockPref("_user.js.parrot", "9000 syntax error: the parrot's cashed in 'is chips!");
...
***/
lockPref("_user.js.parrot", "9999 syntax error: the parrot's shuffled off 'is mortal coil!");
...
lockPref("_user.js.parrot", "SUCCESS: No no he's not dead, he's, he's restin'!");
