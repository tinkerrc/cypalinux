...
pref("_user.js.parrot", "START: Oh yes, the Norwegian Blue... what's wrong with it?", locked);

/* 0000: disable about:config warning ***/
pref("browser.aboutConfig.showWarning", false, locked);

/*** [SECTION 0100]: STARTUP ***/
pref("_user.js.parrot", "0100 syntax error: the parrot's dead!", locked);
...
pref("_user.js.parrot", "0200 syntax error: the parrot's definitely deceased!", locked);
/* 0201: use Mozilla geolocation service instead of Google if permission is granted [FF74+]
 * Optionally enable logging to the console (defaults to false) ***/
pref("geo.provider.network.url", "https://location.services.mozilla.com/v1/geolocate?key=%MOZILLA_API_KEY%", locked);
...
pref("intl.accept_languages", "en-US, en", locked);
/* 0211: use US English locale regardless of the system locale
 * [SETUP-WEB] May break some input methods e.g xim/ibus for CJK languages [1]
 * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=867501,1629630 ***/
pref("javascript.use_us_english_locale", true, locked);

/*** [SECTION 0300]: QUIETER FOX ***/
pref("_user.js.parrot", "0300 syntax error: the parrot's not pinin' for the fjords!", locked);
/** UPDATES ***/
...
***/
pref("_user.js.parrot", "0400 syntax error: the parrot's passed on!", locked);
...
pref("_user.js.parrot", "0600 syntax error: the parrot's no more!", locked);
...
pref("_user.js.parrot", "0700 syntax error: the parrot's given up the ghost!", locked);
/* 0701: disable IPv6
...
pref("network.file.disable_unc_paths", true, locked);
...
pref("network.gio.supported-protocols", "", locked);
...
pref("_user.js.parrot", "0800 syntax error: the parrot's ceased to be!", locked);
...
pref("extensions.formautofill.available", "off", locked);
pref("extensions.formautofill.creditCards.available", false, locked);
pref("extensions.formautofill.creditCards.enabled", false, locked);
pref("extensions.formautofill.heuristics.enabled", false, locked);
...
***/
pref("_user.js.parrot", "0900 syntax error: the parrot's expired!", locked);
...
pref("security.ask_for_password", 2, locked);
/* 0902: set how long in minutes Firefox should remember the primary password (0901) ***/
pref("security.password_lifetime", 5, locked);
...
pref("_user.js.parrot", "1000 syntax error: the parrot's gone to meet 'is maker!", locked);
...
pref("browser.privatebrowsing.forceMediaMemoryCache", true, locked);
pref("media.memory_cache_max_size", 65536, locked);
/* 1003: disable storing extra session data [SETUP-CHROME]
 * define on which sites to save extra session data such as form content, cookies and POST data
 * 0=everywhere, 1=unencrypted sites, 2=nowhere ***/
pref("browser.sessionstore.privacy_level", 2, locked);
...
pref("browser.sessionstore.interval", 30000, locked);
/* 1005: disable automatic Firefox start and session restore after reboot [FF62+] [WINDOWS]
 * [1] https://bugzilla.mozilla.org/603903 ***/
pref("toolkit.winRegisterApplicationRestart", false, locked);
/* 1006: disable favicons in shortcuts
 * URL shortcuts use a cached randomly named .ico file which is stored in your
 * profile/shortcutCache directory. The .ico remains after the shortcut is deleted
 * If set to false then the shortcuts use a generic Firefox icon ***/
pref("browser.shell.shortcutFavicons", false, locked);
...
***/
pref("_user.js.parrot", "1200 syntax error: the parrot's a stiff!", locked);
...
pref("security.pki.sha1_enforcement_level", 1, locked);
...
pref("dom.security.https_only_mode_send_http_background_request", false, locked);
...
/*** [SECTION 1400]: FONTS ***/
pref("_user.js.parrot", "1400 syntax error: the parrot's bereft of life!", locked);
...
***/
pref("_user.js.parrot", "1600 syntax error: the parrot rests in peace!", locked);
...
pref("network.http.referer.XOriginTrimmingPolicy", 2, locked);
...
***/
pref("_user.js.parrot", "1700 syntax error: the parrot's bit the dust!", locked);
/* 1701: enable Container Tabs and its UI setting [FF50+]
 * [SETTING] General>Tabs>Enable Container Tabs ***/
pref("privacy.userContext.enabled", true, locked);
pref("privacy.userContext.ui.enabled", true, locked);
...
pref("_user.js.parrot", "2000 syntax error: the parrot's snuffed it!", locked);
...
pref("media.peerconnection.ice.proxy_only_if_behind_proxy", true, locked);
...
pref("media.autoplay.blocking_policy", 2, locked);
...
***/
pref("_user.js.parrot", "2300 syntax error: the parrot's off the twig!", locked);
...
pref("_user.js.parrot", "2400 syntax error: the parrot's kicked the bucket!", locked);
/* 2401: disable "Confirm you want to leave" dialog on page close
 * Does not prevent JS leaks of the page close event
 * [1] https://developer.mozilla.org/docs/Web/Events/beforeunload ***/
pref("dom.disable_beforeunload", true, locked);
...
pref("dom.popup_allowed_events", "click dblclick mousedown pointerdown", locked);

/*** [SECTION 2600]: MISCELLANEOUS ***/
pref("_user.js.parrot", "2600 syntax error: the parrot's run down the curtain!", locked);
...
pref("browser.helperApps.deleteTempFileOnExit", true, locked);
...
pref("middlemouse.contentLoadURL", false, locked);
...
pref("pdfjs.enableScripting", false, locked);
/* 2621: disable links launching Windows Store on Windows 8/8.1/10 [WINDOWS] ***/
pref("network.protocol-handler.external.ms-windows-store", false, locked);
/* 2623: disable permissions delegation [FF73+]
 * Currently applies to cross-origin geolocation, camera, mic and screen-sharing
 * permissions, and fullscreen requests. Disabling delegation means any prompts
 * for these will show/use their correct 3rd party origin
 * [1] https://groups.google.com/forum/#!topic/mozilla.dev.platform/BdFOMAuCGW8/discussion ***/
pref("permissions.delegation.enabled", false, locked);
...
pref("browser.download.alwaysOpenPanel", false, locked);
/* 2653: disable adding downloads to the system's "recent documents" list ***/
pref("browser.download.manager.addToRecentDocs", false, locked);
...
pref("extensions.enabledScopes", 5, locked);
pref("extensions.autoDisableScopes", 15, locked);
...
***/
pref("_user.js.parrot", "2700 syntax error: the parrot's joined the bleedin' choir invisible!", locked);
...
pref("browser.contentblocking.category", "custom", locked);
...
pref("dom.storage.next_gen", true, locked);

/*** [SECTION 2800]: SHUTDOWN & SANITIZING ***/
pref("_user.js.parrot", "2800 syntax error: the parrot's bleedin' demised!", locked);
...
pref("network.cookie.thirdparty.nonsecureSessionOnly", true, locked);
...
pref("privacy.clearOnShutdown.cookies", false, locked);
...
pref("privacy.cpd.cache", true, locked);
pref("privacy.cpd.formdata", true, locked);
pref("privacy.cpd.history", true, locked);
pref("privacy.cpd.sessions", true, locked);
pref("privacy.cpd.cookies", false, locked);
pref("privacy.cpd.offlineApps", true, locked);
...
pref("privacy.sanitize.timeSpan", 0, locked);
...
***/
pref("_user.js.parrot", "4000 syntax error: the parrot's pegged out", locked);
...
***/
pref("_user.js.parrot", "4500 syntax error: the parrot's popped 'is clogs", locked);
...
pref("privacy.resistFingerprinting.letterboxing", true, locked);
...
pref("browser.display.use_system_colors", false, locked);
/* 4511: enforce non-native widget theme
 * Security: removes/reduces system API calls, e.g. win32k API [1]
 * Fingerprinting: provides a uniform look and feel across platforms [2]
 * [1] https://bugzilla.mozilla.org/1381938
 * [2] https://bugzilla.mozilla.org/1411425 ***/
pref("widget.non-native-theme.enabled", true, locked);
...
pref("browser.link.open_newwindow.restriction", 0, locked);
...
***/
pref("_user.js.parrot", "5000 syntax error: the parrot's taken 'is last bow", locked);
...
***/
pref("_user.js.parrot", "5500 syntax error: this is an ex-parrot!", locked);
...
pref("_user.js.parrot", "6000 syntax error: the parrot's 'istory!", locked);
...
pref("privacy.window.name.update.enabled", true, locked);
/* 6050: prefsCleaner: reset previously active items removed from arkenfox FF91+ ***/
   // placeholder

/*** [SECTION 7000]: DON'T BOTHER ***/
pref("_user.js.parrot", "7000 syntax error: the parrot's pushing up daisies!", locked);
/* 7001: disable APIs
...
***/
pref("_user.js.parrot", "8000 syntax error: the parrot's crossed the Jordan", locked);
/* 8001: disable APIs ***/
...
***/
pref("_user.js.parrot", "9000 syntax error: the parrot's cashed in 'is chips!", locked);
...
***/
pref("_user.js.parrot", "9999 syntax error: the parrot's shuffled off 'is mortal coil!", locked);
...
pref("_user.js.parrot", "SUCCESS: No no he's not dead, he's, he's restin'!", locked);
